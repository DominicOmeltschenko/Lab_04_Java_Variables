public class Main {
 public static void main(String[] args) {
     ...
     int intQuotient = 2; // if I had used two ints above that didn't divide evenly, this would be rounded
     int intModulo = 98;
     double doubleOperandA = 3.73;
     double doubleOperandB = 7.73;
     double doubleSum = 0.44;
     double doubleProduct = 18.38;
     double doubleDifference = 27.77;
     double doubleQuotient = 44.69;
    ...
    int familykidNumber = 2;

     System.out.println("The number of kids in my family is: " + familykidNumber);

    boolean isRaining = false;

     System.out.println("It is raining right now: " + isRaining);

    double gasgallonCost = 2.94;

     System.out.println("The cost of a gallon of gas in ohio is: " + gasgallonCost);
    ...
    String myName = "Dominic Omeltschenko";
